...
module "web_instance_asg" {
  ...
  aws_launch_config_security_group             = [module.secgrp.web_security_group_id]
  ...
  asg_group_vpc_zone_identifier                = module.network.web_private_subnet_ids
...
module "alb" {
  ...
  subnet_id              = module.network.lb_public_subnet_ids
